...
release = find_version("..","powerbox", "__init__.py")
...
latex_documents = [
    (master_doc, 'powerbox.tex', u'powerbox Documentation',
...
man_pages = [
    (master_doc, 'powerbox', u'powerbox Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'powerbox', u'powerbox Documentation',
     author, 'powerbox', 'One line description of project.',
     'Miscellaneous'),
]
